...
namespace learn_Pokemon_Review_App.Repositories
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        public bool CreateCategory(Category category)
        {
            ...
            // connected (90%) vs disconnected (uncommon)
            // EntityState.Added => using disconnected state
        ...
        public bool Save()
        {
            // _context.SaveChanges() takes the changes
            // convert it into SQL, and send to DB
